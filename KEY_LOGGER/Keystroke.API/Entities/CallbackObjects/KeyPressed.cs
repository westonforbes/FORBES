namespace Keystroke.API.CallbackObjects
{
    public class KeyPressed
    {
        ...
        private string ConvertKeyCodeToString()
        {
            ...
            if (KeyCode == KeyCode.Snapshot) return "{PRTSC}";
            if (KeyCode == KeyCode.Scroll) return "{SCROLLLOCK}";
            ...
            if (KeyCode == KeyCode.Prior) return "{PGUP}";
            if (KeyCode == KeyCode.Next) return "{PGDN}";
